const PrivacyPolicy = () => {
  return (
    <div className="w-full flex flex-col items-center my-5 px-4 md:px-6 lg:px-8">
      <div className="max-w-3xl w-full space-y-6">
        ...
        <section>
          <h3 className="text-lg md:text-xl font-semibold">1. Introdução</h3>
          <p className="text-justify md:text-left">
            Bem-vindo(a) ao site da <span className="font-bold">Tratorino</span>
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-2">
            <li>
              ...
              telefone, entre outros, quando você preenche formulários em nosso
              site.
            </li>
            <li>
              <strong>Dados de navegação:</strong> Endereço IP, tipo de
              navegador, páginas visitadas, tempo de permanência e cookies.
            </li>
          </ul>
        </section>
        <section>
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-2">
            <li>
              Quando necessário para fornecer serviços solicitados por você.
            </li>
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li>
              Solicitar mais informações sobre como seus dados são usados.
            </li>
          </ul>
        </section>
        <section>
          ...
          <p className="text-justify md:text-left">
            Adotamos medidas de segurança para proteger suas informações, mas
            nenhum sistema é 100% seguro. Caso haja qualquer incidente de
            segurança, tomaremos as providências necessárias.
          </p>
        </section>
        <section>
          <h3 className="text-lg md:text-xl font-semibold">
        ...
        <section>
          <h3 className="text-lg md:text-xl font-semibold">9. Contato</h3>
          <p className="text-justify md:text-left">
